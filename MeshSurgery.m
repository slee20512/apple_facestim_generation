function [newMesh,optim_param]= MeshSurgery(t,part_string,smoothingArea,newMesh,id_string)
global condition partB partIndices...
    baseF baseV baseTR baseVN baseVA targetCoord partV partBoundaryIndMap
